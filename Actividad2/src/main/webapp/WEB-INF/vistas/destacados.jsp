...
<body>
	...
	<nav>
		<div class="topnav">
		  ...
		  <div class="borde"><a class="active" href="/eventos/listarDestacados">Destacados</a></div>
	...
	<h3><a href="/eventos/altaEventoNuevo">Nuevo Evento</a></h3>
		...
		<h2>Listado abreviado de Eventos - Destacados</h2>
			...
			<tr>
		  	...
		  	<c:forEach var="ele" items="${listaEventos}">
			  	<tr>
				    ...
				    <td><fmt:formatDate pattern = "dd-MM-yyyy" value = "${ele.fechaInicio}" /></td>
				    <td>${ele.estado}</td>
